        ...
        <div className="flex flex-col justify-center items-center h-screen font-montserrat bg-[url('./assets/bgfundo.png')] bg-cover bg-center bg-no-repeat">
            ...
            {!isResgisterOpen && (
                <form action="" className="flex flex-col gap-10 bg-primary rounded-xl p-10 px-20">
                    ...
                    <input type="text" placeholder="e-mail" className="px-5 text-h4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    <input type="text" placeholder="senha" className="px-5 text-h4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            ...
            {isResgisterOpen && (
                <form action="" className="flex flex-col justify-center gap-10 rounded-xl bg-primary p-10 px-20">
                    ...
                    <input type="text" placeholder="E-mail" className="px-5 text-h4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    <input type="text" placeholder="Telefone" className="px-5 text-h4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    <input type="text" placeholder="Senha" className="px-5 text-h4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    <input type="text" placeholder="Repita a senha" className="px-5 text-h4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" />
