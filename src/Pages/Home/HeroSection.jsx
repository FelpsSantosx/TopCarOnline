...
const HeroSection = ({ scrollToCarShowcase }) => {
    return (
        ...
        <section className=" font-montserrat bg-[url('./assents/bgfundo.png')] bg-cover bg-center h-screen bg-no-repeat flex flex-col items-center justify-center text-primary" >
            ...
            <Button onClick={scrollToCarShowcase} color="bg-primary text-second hover:bg-second hover:text-primary" className="text-h3 px-5 flex items-center gap-4">Comece agora
                <img src="../src/assents/Vector.png" alt="vector" />
            </Button>
        </section>
